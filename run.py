...
def generate_certificates():
   ...
   for index, name in enumerate(list_of_names):
      certificate_template_image = cv2.imread("Horizon-Certificate1.png")
      cv2.putText(certificate_template_image, name.strip(), (690,690), cv2.FONT_HERSHEY_SIMPLEX,5, (0, 0, 250), 5, cv2.LINE_AA)
